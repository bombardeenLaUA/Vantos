    ...
    <div className="min-h-screen bg-vantos-dark pt-24 pb-16 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-slate-400 text-lg text-center leading-relaxed mb-16 max-w-2xl mx-auto">
          La banca tradicional juega con la opacidad. Vantos juega con la claridad. Entiende las reglas del juego antes
          de mover tu dinero.
        </p>

        {/* Enlace al artículo SEO */}
        <div className="mb-16 flex justify-center">
          <Link
            href="/guia/amortizar-o-invertir"
            className="inline-flex items-center justify-center px-6 py-3 rounded-xl bg-white/5 border border-white/20 text-white hover:bg-vantos-gold hover:text-vantos-dark hover:border-vantos-gold transition-all font-medium"
          >
            Amortizar hipoteca o invertir: guía matemática
          </Link>
        </div>
          ...
          <div className="space-y-2">
            {faqs.map((faq, i) => (
              ...
              >
                ...
                <div className="px-6 pb-4 pt-0 text-slate-300 leading-relaxed">{faq.answer}</div>
              </details>
            ))}
          </div>
        </section>
