      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-slate-300 leading-relaxed space-y-8">
          <section>
            ...
            <p>
              Vantos es un proyecto educativo. Este sitio web y sus herramientas son de titularidad de Vantos, proyecto orientado a la divulgación y educación financiera.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              El diseño gráfico, la estructura, los contenidos, el código fuente y cuantos elementos conforman este sitio web son titularidad de Vantos. Queda prohibida su reproducción, distribución o utilización sin autorización expresa.
            </p>
          </section>
